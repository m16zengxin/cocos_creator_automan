import {UIVertexFormat, GFXAttributeName, _decorator, Component, Node, Vec4, Vec3, director, ModelComponent, CameraComponent, systemEvent, SystemEvent, Touch, geometry, Vec2, EventTouch } from "cc";
import * as cc from "cc";
const { ccclass, property } = _decorator;

@ccclass('WaterCtr')
export class WaterCtr extends Component {
    ...
    private onTouchStart(touch:Touch) {
        ...
        console.log("touchaa==", touch.getLocation());
        // console.log("touch00==", touch._point);
        // console.log("touch11==", touch._point);
